...
public class ArtistRating extends AppCompatActivity {
        ...
        databaseTracks.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    TrackForArtistRating track = postSnapshot.getValue(TrackForArtistRating.class);
                    tracks.add(track);
                }
                Tracklistclass trackListAdapter = new Tracklistclass(ArtistRating.this, tracks);
    ...
    private void saveTrack() {
        ...
        if (!TextUtils.isEmpty(trackName)) {
            ...
            TrackForArtistRating track = new TrackForArtistRating(id, trackName, rating);
